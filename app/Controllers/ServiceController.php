...
class ServiceController
{
    public function categoriesWithServices(): void
    {
        ...
        $services = $pdo->query('SELECT id, category_id, name, description, duration_minutes, price, is_addon, is_active FROM services WHERE is_active = 1 ORDER BY is_addon ASC, sort_order ASC, id ASC')->fetchAll();
        ...
        json_response(['success' => true, 'data' => ['categories' => array_values($grouped)]]);
    }
